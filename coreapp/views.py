...
from .scripts.upload import get_auth_token, process_file

BAD_REQUEST = "Bad request body."
DUPLICATE_PHONE_NUMBER = "Non-unique - Either phone_number or client_member_id already exists for this account."
    ...
    def create_members(self, request):
        ...
        if not data or (data and not isinstance(data, list)):
            ...
            try:
                ...
                print("Exception Occurred: ", e)
                return Response(
                    {"response": BAD_REQUEST, "details": serializer.errors},
...
def member_upload(request):
    ...
    if request.method == 'POST':
        ...
        print("Has csv file been processed: ", is_processed)
        context = {}
